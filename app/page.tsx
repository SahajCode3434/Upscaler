  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center px-4 py-10 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <img src="/hikari-logo.png" alt="Hikari AI" className="w-14 h-14 mb-3" />
      ...
      {previewURL && (
        <div className="relative z-10 mt-8">
          ...
          <img src={previewURL} alt="Preview" className="max-w-full border border-gray-600 rounded-xl shadow-md" />
        </div>
      )}
      ...
      {imageURL && (
        <div className="relative z-10 mt-8">
          ...
          <img src={imageURL} alt="Upscaled" className="max-w-full border border-yellow-500 rounded-xl shadow-lg" />
          <a
            href={imageURL}
